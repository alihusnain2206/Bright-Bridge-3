        ...
        {step === 3 && (
          <div className="px-8 py-6 space-y-4">
            ...
            <div className="flex items-start gap-2 px-3 py-2.5 bg-amber-50 rounded-xl border border-amber-200 text-sm text-amber-800">
              <AlertTriangle className="h-4 w-4 shrink-0 mt-0.5" />
              <div><strong>Beneficial Owner Required</strong> — This must be the actual business owner with 25%+ equity or a C-level executive. This is NOT Joanne or BrightBridge. Required by law for KYB verification.</div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">

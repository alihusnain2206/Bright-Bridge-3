...
export const store = {
  ...
  createManagerUser(data: { name: string; email: string; position: string; companyId: string; password?: string; role?: "owner" | "manager" }): { user: Omit<TestUser, "password">; password: string } {
